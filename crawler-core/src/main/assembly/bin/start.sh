#!/bin/bash
#environment
JAVA_HOME="/export/servers/jdk1.7"
export JAVA_HOME
...
nohup java $JAVA_OPTS $JAVA_MEM_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS -classpath $CONF_DIR:$LIB_JARS com.jdjr.crawler.core.StartCrawlerEngine > $STDOUT_FILE 2>&1 &
