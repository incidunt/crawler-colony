package script.p2p.changjiudai;
...
public class Init implements Script {
    ...
    public List<Task> work(Crawler crawler, Job job) throws Exception {
        ...
        for(Keyword keyword : DB.getKeyWorld(0,100,crawler,job)){
            ...
            newCrawler.setUrl("http://www.changjiudai.com/index.php?user&q=action/check_mobilephone");
            newCrawler.setBody("phoneno="+keyword.getKeyword());
