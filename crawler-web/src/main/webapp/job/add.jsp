...
<br/>
<form id="myform" class="form-horizontal" role="form" action="add.action" method="post" enctype="multipart/form-data">

    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" >projectId</label>
        <div class="col-sm-9">
            <input type="text"  name="projectId" class="col-xs-10 col-sm-5"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" >sourceId</label>
        <div class="col-sm-9">
            <input type="text"  name="sourceId" class="col-xs-10 col-sm-5"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" >jobId</label>
        <div class="col-sm-9">
            <input type="text"  name="jobId" class="col-xs-10 col-sm-5"/>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text"  name="period" class="col-xs-10 col-sm-5"/>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text"  name="nextStartDate"/>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input data-rel="tooltip" type="text" id="form-field-16"  name="priority"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label no-padding-right" for="form-field-17">最大线程数</label>
        <div class="col-sm-9">
            <input data-rel="tooltip" type="text" id="form-field-17" name="maxThread"/>
        </div>
    </div>
    <div class="form-group" >
        <label class="col-sm-3 control-label no-padding-right" >note</label>
        <div class="col-sm-9">
            <input type="text" name="note" class="col-xs-10 col-sm-5"/>
        </div>
    </div>
    <div class="form-group" >
        <label class="col-sm-3 control-label no-padding-right" >Files</label>
        <div class="col-sm-9">
            <input class="filePrew"  tabIndex="3" type="file" size="3" name="files" multiple/>
        </div>
    </div>
